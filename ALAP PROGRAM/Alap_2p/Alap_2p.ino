...
#define MOTOR1_A 12                                                //MOTOR  --meghatarozza MOTOR1_A 2
#define MOTOR1_B 13                                                //MOTOR  --meghatarozza MOTOR1_B 3 
#define MOTOR2_A 7                                               //MOTOR  --meghatarozza MOTOR2_A 1 
#define MOTOR2_B 5                                                //MOTOR  --meghatarozza MOTOR2_B 4  
#define MOTOR3_A 0                                                //MOTOR  --meghatarozza MOTOR3_A 5 
#define MOTOR3_B 6                                                //MOTOR  --meghatarozza MOTOR3_B 7
#define MOTOR4_A 10                                                //MOTOR  --meghatarozza MOTOR4_A 0
#define MOTOR4_B 16                                                //MOTOR  --meghatarozza MOTOR4_B 6 
...
Ultrasonic ultrasonic( 47, 46 );                                  //SZENZOR  --megadja a szenzor labait
...
void loop()
{
  ...
  if (cm<=10)   //SZENZOR-- magyarul== Ha a szenzor <=10cm re van valamitol akkor ((:))                                                
